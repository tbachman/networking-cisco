...
class PktStats(object):
    ...
    def write_to_file(self, f):
        f.write('%s: from_client %d, to_server %d, from_server '
                '%d, to_client %d\n' %
                (self.net_id, self.pkts_from_client, self.pkts_to_server,
                 self.pkts_from_server, self.pkts_to_client))
...
class DebugStats(object):
    ...
    def __init__(self, stats_type):
        ...
        self.total_stats = PktStats('Total ' + stats_type.upper() + ' Stats')
    ...
    def add_network_stats(self, net_id):
        ...
        self.per_network_stats[net_id] = PktStats(net_id)
