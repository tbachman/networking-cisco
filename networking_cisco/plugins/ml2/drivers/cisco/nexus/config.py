...
ml2_cisco_opts = [
    ...
    cfg.BoolOpt('vrf_enabled', default=False,
                help=_("Create VRF's for neutron routers on switches")),
    cfg.BoolOpt('nat_enabled', default=False,
                help=_("Create Floating IP's and external gateways")),
